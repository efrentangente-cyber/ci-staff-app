#!/usr/bin/env python3
"""
Add 50 sample applications directly to PostgreSQL
"""
...
# Copy all the data from generate_sample_applications.py
FIRST_NAMES = [
...
print("=" * 80)
print("ADDING 50 APPLICATIONS TO POSTGRESQL")
print("=" * 80)
print()
    ...
    try:
        ...
        if status in ['ci_completed', 'approved', 'disapproved', 'deferred']:
            ...
            app_data.update({
                ...
                'ci_latitude': 9.3000 + random.uniform(-0.1, 0.1),
...
print()
print("=" * 80)
print(f"✅ CREATED {created_count} APPLICATIONS IN POSTGRESQL!")
print("=" * 80)
print()
